...
function Router() {
  return <DashboardLayout><Switch><Route path="/" component={Home} /><Route path="/chat" component={CommandCenter} /><Route path="/agents" component={AgentsView} /><Route path="/runs" component={RunsBoard} /><Route path="/approvals" component={ApprovalsView} /><Route path="/audit" component={AuditView} /><Route path="/policies" component={PoliciesView} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch></DashboardLayout>;
}
