...
function DashboardLayoutContent({ children, setSidebarWidth }: { children: React.ReactNode; setSidebarWidth: (width: number) => void }) {
  ...
  const toggleOfflineMode = () => { const next = !offlineMode; setOfflineMode(next); localStorage.setItem("agent-ops-execution-mode", next ? "offline" : "cloud"); window.dispatchEvent(new CustomEvent("agent-ops:execution-mode", { detail: { mode: next ? "offline" : "cloud" } })); };
